      ...
      <div className="navbar-start flex items-center gap-2">
        ...
        >
          ...
          <div className="flex-col hidden sm:flex">
            <span className="font-bold transition-colors duration-200 group-hover:text-blue-400">TheFitBot.in</span>
            <span className="text-xs text-gray-500 dark:text-gray-400">by samay</span>
          </div>
        </Link>
      </div>
