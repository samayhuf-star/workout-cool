export const LocalizedMetadata = {
  en: {
    title: "TheFitBot.in - by samay",
    description: "Your AI fitness buddy - comprehensive AI-powered fitness coaching platform with exercise database",
    keywords: [
      "AI fitness",
      "fitness buddy",
      "AI workout",
    ...
    ogAlt: "TheFitBot.in - Your AI fitness buddy",
    applicationName: "TheFitBot.in",
    category: "fitness",
